...
public abstract class GiveCommandMixin {
    ...
    private static ItemEntity handleDrop(ServerPlayer player, ItemStack stack, boolean randomly, boolean thrownFromHand, Operation<ItemEntity> original) {
        ((PlayerDropHandler) player).flan$setForcedDrop(true);
        ItemEntity entity = original.call(player, stack, randomly, thrownFromHand);
